...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Korisnik\Desktop\fer\PROJEKT\vault\grpc\env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Korisnik\Desktop\fer\PROJEKT\vault\grpc\env\Scripts\deactivate.nu'
